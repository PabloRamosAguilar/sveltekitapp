...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li0, file$3, 6, 2, 75);
    			add_location(li1, file$3, 9, 2, 120);
    			add_location(li2, file$3, 12, 2, 177);
    			attr_dev(ul, "class", "svelte-1qy3ixt");
    			add_location(ul, file$3, 5, 1, 68);
    			attr_dev(nav, "class", "svelte-1qy3ixt");
    ...
    const file$2 = "src/Buscar.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			input = element("input");
    			t0 = space();
    			t1 = text(/*busqueda*/ ctx[0]);
    			attr_dev(input, "type", "search");
    			add_location(input, file$2, 6, 0, 48);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*busqueda*/ 1) set_data_dev(t1, /*busqueda*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    class Buscar extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { busqueda: 0 });
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Nav, Router, Contenido });
    	return [];
    }
